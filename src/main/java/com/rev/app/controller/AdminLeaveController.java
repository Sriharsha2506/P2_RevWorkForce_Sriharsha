...
public class AdminLeaveController {
    ...
    @GetMapping
    public String leaveReport(@RequestParam(value = "empId", required = false) String empId,
    ...
    public String doAdjust(@RequestParam("empId") String empId, 
                          @RequestParam("leaveTypeId") Long leaveTypeId, 
                          @RequestParam("adjustment") Integer adjustment) {

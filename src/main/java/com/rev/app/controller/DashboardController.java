...
public class DashboardController {
        ...
        if (userOpt.isPresent()) {
            ...
            if (user.getRole() == com.rev.app.entity.User.Role.ROLE_ADMIN) {
                ...
                if (employee != null) {
                    ...
                    org.springframework.data.domain.Page<LeaveDto> pendingLeavesPage = leaveService
                            .getPendingLeavesForManager(employee.getEmpId(), 0, 100, "leaveId");
                    model.addAttribute("pendingLeavesCount", pendingLeavesPage.getTotalElements());

                    // Dynamic Pending Reviews Count
                    org.springframework.data.domain.Page<PerformanceReviewDto> teamReviewsPage = performanceService
                            .getTeamReviews(employee.getEmpId(), 0, 100, "reviewId");
                    ...
                    // Dynamic Team on Leave Count (Simplified: items in TeamLeaves are usually
                    // upcoming/current)
                    // In a real app, check if today is between startDate and endDate
                    org.springframework.data.domain.Page<LeaveDto> teamLeavesPage = leaveService
                            .getTeamLeaves(employee.getEmpId(), 0, 100, "leaveId");
                ...
                if (employee != null) {
                    ...
                    org.springframework.data.domain.Page<PerformanceReviewDto> reviewsPage = performanceService
                            .getEmployeeReviews(employee.getEmpId(), 0, 100, "reviewId");
    ...
    public String announcements(
            ...
            Model model) {
        org.springframework.data.domain.Page<com.rev.app.dto.AnnouncementDto> announcementsPage = announcementService

...
public class ManagerLeaveController {
    ...
    public String viewTeamLeaves(
            ...
            @RequestParam(value = "sortBy", defaultValue = "leaveId") String sortBy,
    ...
    @PostMapping("/approve")
    public String approveLeave(@RequestParam("leaveId") Long leaveId, @RequestParam(value = "comment", required = false) String comment, Principal principal) {
        if (principal != null) {
            String email = principal.getName();
            Optional<User> userOpt = userService.findByEmail(email);
            if (userOpt.isPresent()) {
    ...
    @PostMapping("/reject")
    public String rejectLeave(@RequestParam("leaveId") Long leaveId, @RequestParam("comment") String comment, Principal principal) {

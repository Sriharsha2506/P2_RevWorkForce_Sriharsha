...
public class ManagerPerformanceController {
    ...
    public String viewTeamPerformance(
            ...
            @RequestParam(value = "sortBy", defaultValue = "reviewId") String sortBy,
    ...
    @PostMapping("/review")
    public String submitFeedback(@RequestParam("reviewId") Long reviewId, 
    ...
    public String viewEmployeeGoals(
            ...
            @RequestParam(value = "page", defaultValue = "0") int page,
            @RequestParam(value = "size", defaultValue = "10") int size,
            @RequestParam(value = "sortBy", defaultValue = "goalId") String sortBy,
            Model model) {
    ...
    public String submitGoalComment(@RequestParam("goalId") Long goalId, 
    ...
    public String quickRate(@RequestParam("empId") String empId, 
                            @RequestParam("rating") BigDecimal rating, 
                            @RequestParam("comment") String comment) {

...
public class DataInitializer {
    ...
    public CommandLineRunner logUsers(com.rev.app.repository.UserRepository userRepository) {
        return args -> {
            ...
            userRepository.findByEmailIgnoreCase("sriharshamunjala2506@gmail.com").ifPresent(u -> {
                if (u.getRole() != User.Role.ROLE_ADMIN) {
                    u.setRole(User.Role.ROLE_ADMIN);
                    userRepository.save(u);
                    System.out.println("[DataInitializer] Updated sriharshamunjala2506@gmail.com to ROLE_ADMIN");
                }
            });
